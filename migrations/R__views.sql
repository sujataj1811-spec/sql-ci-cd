...
GO
CREATE OR ALTER VIEW [dbo].[vAssocSeqLineItems]
AS
...
CREATE OR ALTER VIEW [dbo].[vAssocSeqOrders]
AS
...
CREATE OR ALTER VIEW [dbo].[vDMPrep]
AS
    SELECT
...
CREATE OR ALTER VIEW [dbo].[vTargetMail] 
AS
    SELECT
        c.[CustomerKey], 
        c.[GeographyKey], 
...
CREATE OR ALTER VIEW [dbo].[vTimeSeries] 
AS
    SELECT 
        CASE [Model] 
